...
<html lang="en">
    <head>
        ...
        <title>FPI-EED / User Login</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-sm-12">
                                <div class="card shadow-lg card-login border-0 bg-success rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-bold my-1"><i class="fas fa-users fa-4x"></i></h3></div>
                                    <div class="card-body">
                                        <form action="" method="post" id="user-login">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a class="small" href="password.html">Forgot Password?</a><button class="btn btn-warning btn-block" id="submit" type="submit">Login</button></div>
                                        </form>
                                    </div>
