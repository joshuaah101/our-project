...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid">
            <h5 class="mt-4"><a href="admin.php?manage-instructor=modify" class="btn btn-danger"><i class="fas fa-chevron-left"></i> Go Back</a></h5>
            <h4><i class="fas fa-edit"></i> Edit Instructor</h4>
